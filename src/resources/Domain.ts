...
export class Domain {
   ...
   * @param query?
   */
  async byApplicationId(query?: any) {
   ...
   * @param query?
   */
  async canGenerateTraefikMeDomains(query?: any) {
