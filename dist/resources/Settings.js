...
export class Settings {
     ...
     * @param data
     */
    async cleanStoppedContainers(data) {
     ...
     * @param query?
     */
    async haveTraefikDashboardPortEnabled(query) {
