...
export class Compose {
     ...
     * @param query?
     */
    async loadMountsByService(query) {
     ...
     * @param query?
     */
    async getConvertedCompose(query) {
     ...
     * @param data
     */
    async disconnectGitProvider(data) {
